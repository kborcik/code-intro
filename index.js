...
let total = summedNums = Netflix + Hulu + DisneyPlus + YouTubePremium + Peacock;
    console.log(total);
...
let newTotal = summedNums = Netflix + Hulu + DisneyPlus + YouTubePremium + Peacock;
